...
function healer(){
    ...
    fetch(`https://raw.githubusercontent.com/healer-op/HealCloud/main/json/snapvue.json`)
    .then(response =>{
        if(!response.ok){
            throw Error("ERROR");
        }
            ...
            <div class="list-item">
                    <div class="list-item-company">
                        ...
                        <div class="list-item-company-info">
                            <h4 class="list-item-company-name"> Just Bought ${data.product[index]}</h4>
    ...
    healer()
    setInterval(function() {healer()}, Math.floor(Math.random() * 6000) + 1000);